          ...
          {Faqs.map((faq) => (
            ...
            >
              ...
              <AccordionHeader
                ...
                className="ml-[4vw] flex w-full items-center justify-between py-[1vw] text-[5vw] font-semibold sm:py-[0.32vw] sm:text-[1.5vw] lg:text-[1.2vw] bg:ml-[1.25vw]"
              >
              ...
              {/* Válasz */}
              <AccordionBody
                className=" my-[2vw] rounded-lg px-[2vw] text-justify text-[4vw] font-light sm:text-[1.6vw] lg:text-[1.05vw] bg:my-[0.5vw] bg:px-[0.5vw]"
              >
